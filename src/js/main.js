...
//12. Callable entities:
    ...
    console.log(JSON.stringify(testObject2));
  ...
  const obj2 = {};
  addListener(obj2, () => console.log('Hello!'));
  addListener(obj2, () => console.log('My dear world!'));
  addListener(obj2, () => console.log('How are you ?'));

  triggerListeners(obj2);
